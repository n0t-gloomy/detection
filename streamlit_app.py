...
if uploaded_file:
    ...
    with col3:
        if st.session_state.prediction:
            ...
            """, unsafe_allow_html=True)
            st.warning("⚠️ This result is generated by an AI model and is for educational purposes only. It is not a medical diagnosis. Please consult a qualified professional for medical advice.")
