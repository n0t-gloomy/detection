...
def show_warning():
    ...
    st.warning(
        ...
        *   **Research Use Only:** This tool is provided for educational and research purposes. It is NOT a medical diagnostic tool.
        *   **No Professional Advice:** The classifications generated by this AI model should not be interpreted as professional medical or technical advice.
        *   **Accuracy:** AI models can produce "hallucinations" or incorrect classifications. Always verify results with a qualified professional.
        *   **Privacy:** Do not upload sensitive personal data or PII (Personally Identifiable Information).
        
        By clicking **"I Understand and Agree"**, you acknowledge that you have read this notice and assume all risks associated with the use of this application.
        """
    )
...
# 4. Logic: Show Warning or Show App
